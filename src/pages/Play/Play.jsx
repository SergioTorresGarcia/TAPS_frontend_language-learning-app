...
import { GetWordToPlay, GetWords, GetWordsFromLevel, GetWordsLearnt } from "../../services/apiCalls";
...
export const Play = () => {
    ...
    // useEffect(() => {
    //     const getLevelWords = async () => {
    //         try {
    //             const levelId = 1 // This will change (+1) when the level is finished
    //             const fetched = await GetWordsFromLevel(tokenStorage, levelId); // ALL WORDS FROM THE GAME
    //             if (fetched && fetched.data) {
